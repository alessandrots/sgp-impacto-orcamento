...
var concursado_1 = require('./concursado');
var ConcursadoDetailComponente = (function () {
    ...
    ConcursadoDetailComponente = __decorate([
        core_1.Component({
            ...
            providers: [concursado_1.default]
        }), 
        __metadata('design:paramtypes', [http_1.Http, router_1.RouteSegment, router_1.Router, concursado_service_1.ConcursadoService, concursado_1.default])
